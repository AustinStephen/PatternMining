...
* It did not work very well but generates some interesting plots. 
This is probably because I don't know how to find a good 
period just looking at the data and the data changes a lot.

* The last plot shows performance on the test set.

* Next step for me is to write a function that adds together the predictions from 
a harmonic regression like model and the removed trend from the regression.
...
train <- data_1950 %>% filter(dateNumeric < 48588)
test <- data_1950 %>% filter(dateNumeric >= 48588)
data_1950 <- data_1950 %>% 
